...
<img src="images/1.png" alt="Image 1" width="300" height="200">

### Pipenv Installation

When you run the `pipenv install` command, Pipenv will automatically generate the `Pipfile.lock` file.

<img src="images/2.png" alt="Image 2" width="300" height="200">
...
```
<img src="images/3.png" alt="Image 3" width="100%" height="200">

### Install Flask depencency
```bash
pipenv install -dev flask
```
<img src="images/4.png" alt="Image 1" width="100%" height="200">

#### When you check the file, you can see the installed dependencies in the Pipfile and Pipfile.lock files
<img src="images/5.png" alt="Image 4" width="100%" height="200">

### Create a main.py for testing.
<img src="images/6.png" alt="Image 6" width="100%" height="100%">

### Run the file.

<img src="images/7.png" alt="Image 7" width="100%" height="100%">
&nbsp;&nbsp;&nbsp;&nbsp;

<img src="images/8.png" alt="Image 8" width="100%" height="100%">
...
<img src="images/9.png" alt="Image 9" width="100%" height="100%">

### Create .env file and set up variable
<img src="images/10.png" alt="Image 10" width="100%" height="100%">

### To check the environment varible, create test.ipynb.
<img src="images/11.png" alt="Image 11" width="100%" height="100%">

### Update main.py and run.
<img src="images/12.png" alt="Image 12" width="100%" height="100%">

&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;

<img src="images/13.png" alt="Image 13" width="100%" height="100%">